...
class AuctionCreationVC: UIViewController {
    ...
    private let modelTextField = AuthTextField(type: .model)
    private let yearTextField = AuthTextField(type: .nameTextField)
    private let manufacturerTextField = AuthTextField(type: .manufactured)
